    ...
    <div className="space-y-4">
      ...
      <div className="space-y-4">
        ...
        <a 
          ...
          className="group block bg-white rounded-lg border border-gray-200 p-4 bg-[#5865F2]/5 border-[#5865F2]/20 hover:bg-[#5865F2]/10 transition-all duration-300 cursor-pointer overflow-hidden"
        >
          <div className="flex items-center">
            <div className="mr-4">
            ...
            <div className="flex-grow flex items-center justify-between">
              <div>
                ...
                <div className="overflow-hidden transition-all duration-300 group-hover:max-h-20 max-h-0">
                  <p className="text-sm text-gray-600 mt-1">コミュニティに参加して他のプレイヤーと交流しよう</p>
                </div>
              </div>
        ...
        <a 
          ...
          target="_blank" 
          rel="noopener noreferrer"
          className="group block bg-white rounded-lg border border-gray-200 p-4 hover:bg-gray-50 transition-all duration-300 cursor-pointer overflow-hidden"
        >
          <div className="flex items-center">
            <div className="mr-4">
            ...
            <div className="flex-grow flex items-center justify-between">
              <div>
                ...
                <div className="overflow-hidden transition-all duration-300 group-hover:max-h-20 max-h-0">
                  <p className="text-sm text-gray-600 mt-1">現在確認されている問題と対応状況</p>
                </div>
              </div>
        ...
        <a 
          ...
          target="_blank" 
          rel="noopener noreferrer"
          className="group block bg-white rounded-lg border border-gray-200 p-4 bg-pink-50 border-pink-200 hover:bg-pink-100 transition-all duration-300 cursor-pointer overflow-hidden"
        >
          <div className="flex items-center">
            <div className="mr-4">
            ...
            <div className="flex-grow flex items-center justify-between">
              <div>
                ...
                <div className="overflow-hidden transition-all duration-300 group-hover:max-h-20 max-h-0">
                  <p className="text-sm text-gray-600 mt-1">サーバー運営費用をサポートして継続運営にご協力ください</p>
                </div>
              </div>
